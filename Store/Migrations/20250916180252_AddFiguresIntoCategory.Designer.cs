...
namespace Store.Migrations
{
    ...
    [Migration("20250916180252_AddFiguresIntoCategory")]
    partial class AddFiguresIntoCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Chat.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Chat.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Chat.Models.Conversation", b =>
                {
                    b.HasOne("Store.Models.ApplicationUser", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Store.Models.ApplicationUser", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("Store.Chat.Models.Message", b =>
                {
                    b.HasOne("Store.Chat.Models.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Store.Models.ApplicationUser", "Sender")
                        .WithMany()
